...
function createTextTexture(gl: any, text: string, font = 'bold 30px Figtree', color = 'white') {
...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#ffffff', font = '30px Figtree' }: any) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
