...
const BorderGlow = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '190 90 60', // Adjusted default to a cyan
  backgroundColor = '#0A0F1C', // Matches TargetAudienceSection background
  borderRadius = 32, // Matches my rounded-[32px]
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = true,
  colors = ['#38bdf8', '#818cf8', '#c084fc'], // Cyan to Blue to Purple
  fillOpacity = 0.5,
}: BorderGlowProps) => {
