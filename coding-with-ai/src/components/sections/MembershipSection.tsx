...
const memberships = [
  {
    id: "silver",
    name: "AI Coding Starter",
    tagline: "The Foundation",
    description: "Learn AI coding ecosystem and tools. Beginner-friendly guidance.",
    image: "/silver.png",
  ...
  },
  {
    ...
    description: "Build real-world applications using AI. Full project building.",
    image: "/gold.png",
  ...
  {
    id: "diamond",
    name: "AI Founder Diamond",
    tagline: "The Founder Track",
    description: "Monetize apps and AI skills. Freelancing and startup basics.",
    image: "/diamond.png",
    ...
    features: [
      ...
      "Client acquisition & SaaS basics",
    ],
    cta: "Launch & Monetize",
  },
];
